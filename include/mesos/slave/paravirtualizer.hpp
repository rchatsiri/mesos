...
#ifndef __MESOS_SLAVE_PARAVIRTUALIZER_HPP__
#define __MESOS_SLAVE_PARAVIRTUALIZER_HPP__
...
#include <mesos/slave/paravirtualizer.pb.h>


namespace mesos{
namespace slave{

struct ParaVirtualzeIO
{
  class IO
  {
  public:
...
#endif /* __MESOS_SLAVE_PARAVIRTUALIZER_HPP__ */
